<template>
    <div id="permisions-datatable">
            <div class="container mx-auto px-4 sm:px-8">
                <div class="py-8">
                    <div>
                        <h2 class="text-2xl font-semibold leading-tight text-white">Permission</h2>
                    </div>
                    <br>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div v-if="candelete == 1" >
                                                <delete-modal-reusable
                                                    ...
                                                    urldelete="/admin/delete/permissions"
                                                >
                                                </delete-modal-reusable>
                                            </div>
                                            <div v-if="canedit == 1" >
...
export default {
    ...
    data: function() {
        return {
            data: [],
            indexUrl: "/api/permissions/permissions",
            searchUrl: "/api/search/permissions/permissions",
            search: "",
            pagination: "10",
        };
    },
