<template>
    <div id="roles-datatable">
            <div class="container mx-auto px-4 sm:px-8">
                <div class="py-8">
                    <div>
                        <h2 class="text-2xl font-semibold leading-tight text-white">Roles</h2>
                    </div>
                    <br>
                                            ...
                                            <div class="flex items-center">
                                                <div class="ml-3">
                                                    <p class="text-gray-900 whitespace-no-wrap">
                                                        <span class="rounded bg-blue-400 py-1 px-3 text-xs font-bold">{{value.name}}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">{{value.guard_name}}</p>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">
                                                {{value.created_at}}
...
export default {
    ...
    data: function() {
        return {
            data: [],
            indexUrl: "/api/permissions/role",
            searchUrl: "/api/search/permissions/role",
            search: "",
            pagination: "10",
        };
    },
