// Inside thos compoentes you can add any kind of css even javascript
function onixPlugins(editor) {
    ...
    editor.BlockManager.add('onix-simple-box', {
                category: 'Onix',
                label: 'simple-box',
                attributes: { class: 'fa fa-quote-right' },
                content: `
    ...
    editor.BlockManager.add('onix-landing-page', {
            category: 'Onix',
            label: 'lading-page',
            attributes: { class: 'fa fa-quote-right' },
            content: `
    ...
    editor.BlockManager.add('onix-landing-page-2', {
        category: 'Onix',
        label: 'lading-page-2',
        attributes: { class: 'fa fa-quote-right' },
        content: `
